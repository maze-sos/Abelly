...
const ExcelShortcuts = () => {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Excel Shortcuts</Text>
      ...
      <Text style={styles.shortcut}>Ctrl + N: New Workbook</Text>
      <Text style={styles.shortcut}>Ctrl + O: Open Workbook</Text>
      <Text style={styles.shortcut}>Alt + =: AutoSum</Text>
