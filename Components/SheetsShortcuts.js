...
const SheetsShortcuts = () => {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Google Sheets Shortcuts</Text>
      ...
      <Text style={styles.shortcut}>Ctrl + Shift + C: Copy formatting</Text>
      <Text style={styles.shortcut}>Ctrl + Shift + V: Paste formatting</Text>
      <Text style={styles.shortcut}>Ctrl + Shift + Space: Auto-complete formula</Text>
      <Text style={styles.shortcut}>Ctrl + Shift + Enter: Insert new sheet</Text>
    </View>
  );
};
...
export default SheetsShortcuts;