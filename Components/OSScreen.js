  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity onPress={() => navigation.navigate('Windows Shortcuts')} style={styles.buttonContainerStyle}>
          <Text style={styles.buttonText}>Windows</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('Apple Shortcuts')} style={styles.buttonContainerStyle}>
          <Text style={styles.buttonText}>Apple</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('Linux Shortcuts')} style={styles.buttonContainerStyle}>
          <Text style={styles.buttonText}>Linux</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
