...
const XDShortcuts = () => {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>XD Shortcuts</Text>
      ...
      <Text style={styles.shortcut}>Ctrl + N: New Document</Text>
      <Text style={styles.shortcut}>Ctrl + O: Open Document</Text>
      <Text style={styles.shortcut}>Ctrl + Shift + S: Save As</Text>
