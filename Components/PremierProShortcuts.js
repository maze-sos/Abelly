// components/PremierProShortcuts.js
import React from 'react';
import { View, Text, StyleSheet } from 'react-native';

const PremierProShortcuts = () => {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Premier Pro Shortcuts</Text>
      ...
      <Text style={styles.shortcut}>Ctrl + N: New Project</Text>
      <Text style={styles.shortcut}>Ctrl + O: Open Project</Text>
      <Text style={styles.shortcut}>Space: Play/Pause</Text>
...
export default PremierProShortcuts;